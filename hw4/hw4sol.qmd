...
labevents_tble <- labevents_tble |>
  ...
  pivot_wider(names_from = itemid, values_from = valuenum, names_prefix = "item_") 
```
...
summary_table <- mimic_icu_cohort %>%
  select(first_careunit, last_careunit, los, los_long, admission_type, admission_location, discharge_location, insurance, language, marital_status, race, hospital_expire_flag, gender, dod, sodium, chloride, creatinine, potassium, glucose, hematocrit, wbc, bicarbonate, temperature_fahrenheit, non_invasive_blood_pressure_diastolic, respiratory_rate, non_invasive_blood_pressure_systolic, heart_rate, age_intime) %>%
...
<p align="center">
  <img src="https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/main/hw/hw4/Q2example1.png" width="20%">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/main/hw/hw4/Q2example2.png" width="20%">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/ucla-biostat-203b/2024winter/main/hw/hw4/Q2example3.png" width="20%">
</p>

**Answer:**
Please refer to the shiny app file.