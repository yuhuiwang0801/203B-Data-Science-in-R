...
mimic_icu_cohort <- icustays_tble |>
  ...
  mutate(
    age_intime = year(intime) - anchor_year + anchor_age
    ) |>
...
mimic_icu_cohort <- mimic_icu_cohort %>%
  mutate(
    first_careunit = fct_lump(first_careunit, 
                              n = 4, 
                              other_level = "Other")
  )
```
...
mimic_icu_cohort <- mimic_icu_cohort %>%
  mutate(
    last_careunit = fct_lump(last_careunit, 
                             n = 4, 
                             other_level = "Other")
  )
```
...
mimic_icu_cohort <- mimic_icu_cohort %>%
  mutate(
    admission_type = fct_lump(admission_type, 
                              n = 4, 
                              other_level = "Other")
  )
```
