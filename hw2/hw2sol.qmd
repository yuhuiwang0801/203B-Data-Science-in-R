...
```
The run time changed, and it becomes faster. However, the memory usage is the same as the default data types.
...
DuckDB is basically a online analytical processing database. It leverages Structured Query Language (SQL) to analyze data fastly.
