...
labevents_parquet_filtered %>% 
  ...
  head(10)
```
The Parquet file is 136 bytes. The elapsed time of the process is 0.151 seconds. The number of rows and the first 10 rows of the result tibble are the same as Q2.3.
